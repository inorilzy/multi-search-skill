...
PROVIDER_CAPABILITIES: dict[str, ProviderCapability] = {
    ...
    "twitter": ProviderCapability(
        ...
        operation=_op(AuthMode.COOKIE, "twitter", rate_limit_sensitive=True, requires_dependency="xkit-py"),
        scrape_policy=ScrapePolicy.CANDIDATE,
        count_key="twitter",
        timeout_default=20,
        best_for=("social discussion", "tweet text"),
        notes="Search returns candidates; selected X URLs use XKit for full text and loaded replies.",
    ),
    "sov2ex": ProviderCapability(
        name="sov2ex",
        public_name="sov2ex",
        kind=ProviderKind.PLATFORM_SEARCHER,
